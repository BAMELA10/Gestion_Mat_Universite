...
class Login:
    def __init__(self):
        ...
        self.champ2 = tk.Entry(self.frame4, width=20, font=("helvetica", 18), show="*")
...
class UserCreation:
    ...
    def ajout_user(self):
        try:
            ...
            user1 = user(username, password, email, telephone)
            result = user1.create_user()
            if result == True:
